document.getElementById('addevent').addEventListener("click", function () {
    creationPopup()
    console.log(document.getElementById('location').options[document.getElementById('location').selectedIndex].value)
}, false);
...
async function eventForm() {
    ...
    const avatar_content =  document.getElementById("avatar_content").value
